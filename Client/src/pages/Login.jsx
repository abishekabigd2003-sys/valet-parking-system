...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 py-10 relative overflow-hidden bg-themeBg">
      {/* Background blobs */}
      ...
      >
        <Card className="p-6 sm:p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-themeText mb-2">Welcome Back</h1>
            <p className="text-themeText-secondary text-sm text-center">Enter your credentials to access the Valet Management System</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-end mt-2">
              <Link to="/forgot-password" className="text-sm text-themeText-secondary hover:text-primary transition-colors">
                Forgot Password?
              </Link>
            </div>
